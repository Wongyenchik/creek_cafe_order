...
import com.example.sectionedrecyclerview.OrderHistoryAdapter
...
class OrderHistory : Fragment() {
    ...
    override fun onCreateView(
        ...
        recycler_view = view.findViewById(R.id.order_history1)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = OrderHistoryAdapter(requireContext(), orderTotal)
